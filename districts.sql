...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2023 at 06:54 AM
...
CREATE TABLE `districts` (
  ...
  `regency_id` char(5) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `districts`
  ADD CONSTRAINT `districts_ibfk_1` FOREIGN KEY (`regency_id`) REFERENCES `regencies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
